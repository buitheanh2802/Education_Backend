...
import { getsPost, getsQuestion, getSolutions, totalUploadDownloadChallenge, getUser, totalUser, totalAll } from 'controllers/statistic.controller';
...
router.post(path.statistic.totalAll, accessToken, totalAll);
